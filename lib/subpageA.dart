...
class SubpageA extends StatefulWidget {
  @override
  _SubpageAState createState() => _SubpageAState();
}

class _SubpageAState extends State<SubpageA> {

  Widget showImage() {
    return Container(
      width: 380.0,
      child: Image.asset('assets/images/flow60.png'),
    );
  }

  Widget showName() {
    return Text('หลักสูตรปีการศึกษา 2560-ปัจจุบัน',
    ...
    return Container(
      child: Column(
        ...
        Text('จำนวนหน่วยกิตรวมตลอดหลักสูตร 147 หน่วยกิต', style: TextStyle(fontFamily: fontFam, fontSize: 18,),),
          ...
          Text('>>> กลุ่มวิชาพื้นฐานทางวิทยาศาสตร์ 17 หน่วยกิต', style: TextStyle(fontFamily: fontFam, fontSize: 18,),),
          SizedBox(
            height: 4.0,
          ),
          Text('>>> กลุ่มวิชาพื้นฐานวิศวกรรม 23 หน่วยกิต', style: TextStyle(fontFamily: fontFam, fontSize: 18,),),
          SizedBox(
            height: 4.0,
          ),
          Text('>>> กลุ่มวิชาบังคับเฉพาะแขนง 50 หน่วยกิต', style: TextStyle(fontFamily: fontFam, fontSize: 18,),),
          SizedBox(
            height: 4.0,
          ),
