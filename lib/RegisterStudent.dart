...
class RegisterStudentState extends State<RegisterStudent> {
  ...
  startUpload() {
    ...
    if(tmpFile == null || firstName.isEmpty || lastName.isEmpty || studentId.isEmpty || password.isEmpty){
      ...
      uploadData(fileName,firstName,lastName,studentId,password,citizenId,year);
    }
  }
  ...
  uploadData (String fileName, String firstName, String lastName, String studentId, String password, String citizenId, String year) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  Container(padding: EdgeInsets.only(top : 10.0, left: 80, right: 80),
              ...
              children: <Widget>[
                ...
                Container(
                    ...
                    child: TextField(
                      ...
                      autocorrect: true,
                      decoration: InputDecoration(hintText: 'เลขประจำตัวประชาชน',
                ...
                Container(
                    ...
                    child: TextField(
                      ...
                      autocorrect: true,
                      decoration: InputDecoration(hintText: 'ชั้นปี',
                        fillColor: Colors.white,
                        filled: true,
                        border: new OutlineInputBorder(
                          borderRadius: const BorderRadius.all(
